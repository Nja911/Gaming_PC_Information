...
import { gpu } from "./gpu";
import { cpu } from "./cpu";
import { researchedComponentCategories } from "./researched";
...
export const componentCategories: ComponentCategory[] = [cpu, gpu, ...researchedComponentCategories].map((category) => ({ ...category, sources: category.sources ?? marketSources }));
